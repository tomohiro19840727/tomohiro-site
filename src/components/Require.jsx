      ...
      <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8 mt-10">
        ...
        <div class="flex flex-col overflow-hidden rounded-lg border bg-gray-50">
          ...
          <div class="flex flex-1 flex-col p-4 sm:p-6">
            ...
            <p class="mb-8 text-gray-500 font-bold">リスニングスキルや対話能力によって、クライアントの要件や希望を的確に把握し、要件定義を適切に行うことができます。<br/>また、クライアントのビジョンを共有し、デザイン面でもクライアントの要望を反映したデザインを作成することができます。</p>
          </div>
        </div>
        ...
        <div class="flex flex-col overflow-hidden rounded-lg border bg-white">
          ...
          <div class="flex flex-1 flex-col p-4 sm:p-6 bg-red-50">
            ...
            また、クライアントとのコミュニケーションを通じて、改善点や追加要件にも柔軟に対応することができます。</p>
          </div>
        </div>
        ...
        <div class="flex flex-col overflow-hidden rounded-lg border bg-white">
          ...
          <div class="flex flex-1 flex-col p-4 sm:p-6 bg-blue-100">
            ...
            また、品質向上を図りつつ、クライアントに高品質な成果物を納品することが可能です。</p>
          </div>
        </div>  
      </div>
    </div>
