...
useEffect(() => {
  ...
  return (
    ...
    <div className="w-full md:w-48 h-48 rounded-full overflow-hidden flex-shrink-0 md:mr-8">
      <img src="./img/4794985515903460063.d142979e8592baa951b451dcf957498f.22091503.JPG" alt="" className="w-full h-full object-cover" />
    </div>
  </div>
  ...
  <div className="flex items-center w-full h-auto">
    ...
    <div  ref={aboutRef1} className="w-1/2 text-black text-center p-8 text-2xl mt-8 font-bold ">
  ...
  <div className="flex justify-center m-20">
  <div className="flex items-center w-full h-auto">
    <div ref={aboutRef2} className="w-1/2 text-black text-center p-8 text-2xl mt-8 font-bold">
...
<div className="flex justify-center m-20">
  <div className="flex items-center w-full h-auto">
    ...
    <div  ref={aboutRef3} className="w-1/2 text-black text-center p-8 text-2xl mt-8 font-bold">
...
<div className="flex justify-center">
  <div className="flex items-center w-full h-auto">
  <div ref={aboutRef4} className=" w-1/2 text-black text-center p-8 text-2xl mt-8 font-bold ">
